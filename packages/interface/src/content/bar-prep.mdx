...
on memorizing a lot of stuff we could easily Google.

Nonetheless, we have open-sourced our approach to passing the bar exam, and
the following flashcards and outlines are how we have practice "rule
slapdowns", or writing out rule statements over and over again so that they
are ingrained in our muscle memory.
...
2. Start doing practice problems. In California, the last few years of bar
  ...
  Here are some of our mock answers to some questions:

* [February 2020 - Question 3 (Contracts)](/bar-prep/202002-Q3)
...
3. Practice our rule slapdowns via our [flashcards](/bar-prep/flashcards)
  ...
  to bar prep.
4. Read the following outlines only if you feel it's necessary.

* [Business Associations](/bar-prep/business-associations)
