...
death of the testator. If assets are not named, a **pour-over trust** could be
created to receive the assets of the testator. A **totten trust** is a trust
where the trustor places money in a bank account and a beneficiary can take
any amount left over upon their death.
...
to find an adequate substitition of that gift.

An **honarary trust** is one where there is neither a private beneficiary nor a
charitable purpose.
...
A **constructive trust** is a remedy to prevent unjust encrichment such as
...
A trustee is liabile for violating their trustee duties, committing torts,
...
*constructive trustee* and have obligations to the beneficiary.

Beneficiaries are like shareholders in a corporation and are entitled to
income and are obligated to pay interest on loans takes, and minor repairs.
